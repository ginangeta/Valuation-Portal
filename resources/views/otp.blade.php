        ...
        <div class="page-wrapper">
            ...
            <div class="login-content fluid-container ">
                ...
                <div class="d-flex flex-column login-form-container">
                    <form id="reset_form" action="{{ route('validateOTP') }}" method="POST"
                        ...
                        <div class="login-form-header p-1">
                            <h2 class="mb-2">Validate One Time Pin</h2>
                        ...
                        <div class="form-group">
                            ...
                            <div class="input-email-login">
                                <input name="phone" type="phone" class="form-control"
                                    placeholder="Enter your phonenumber" value="{{Session::get('userphone')}}" required>
                            </div>
                        ...
                        <div class="form-group">
                            <label>
                                <strong>Sent OTP</strong> <strong class="text-danger">*</strong>
                            </label>
                            {{-- <input name="user_name" value="{{old('user_name')}}" type="email" class="form-control" placeholder="Enter your email address" required> --}}
                            <div class="input-pass-login">
                                <input name="otp" type="password" class="form-control"
                                    placeholder="Enter the sent otp" required>
                            </div>

                        </div>

                        <button type="submit" class="btn btn-primary block center btn-block mb-3 py-2 btn-control">Validate
