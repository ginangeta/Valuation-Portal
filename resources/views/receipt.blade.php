...
<body data-new-gr-c-s-check-loaded="8.872.0" data-gr-ext-installed="">
    <img style="position:absolute;top:0.90in;left:1.37in;width:1.07in;height:1.04in" src="{{asset('receipt/ri_1.png')}}">
    ...
    <img style="position:absolute;top:2.20in;left:1.50in;width:3.86in;height:0.02in" src="{{asset("receipt/vi_1.png")}}">
    ...
    <img style="position:absolute;top:2.57in;left:1.16in;width:3.14in;height:0.01in" src="{{asset('receipt/vi_2.png')}}">
    ...
    <div style="position:absolute;top:2.4in;left:4.72in;width:1.07in;line-height:0.14in;"><span
            style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Times;color:#000000">{{ date('d-m-Y', strtotime($receipt->created_at)) }}</span><br>
    </div>
    <img style="position:absolute;top:2.57in;left:4.72in;width:1.30in;height:0.01in" src="{{asset("receipt/vi_3.png")}}">
    ...
    <div style="position:absolute;top:2.80in;left:2.19in;width:0.91in;line-height:0.12in;"><span
            style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Times;color:#000000;white-space:nowrap">{{ $receipt->billed_user }}</span><span
            style="font-style:normal;font-weight:bold;font-size:7pt;font-family:Times;color:#000000"> </span><br></div>
    <img style="position:absolute;top:2.96in;left:1.97in;width:2.33in;height:0.01in" src="{{asset("receipt/vi_4.png")}}">
    ...
    <div style="position:absolute;top:2.79in;left:5.15in;width:0.45in;line-height:0.14in;"><span
            style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Times;color:#000000;white-space:nowrap">{{ $receipt->amount_paid }}</span><br>
    </div>
    <img style="position:absolute;top:2.96in;left:4.93in;width:1.08in;height:0.01in" src="{{asset("receipt/vi_5.png")}}">
    ...
    <div style="position:absolute;top:3.22in;left:1.89in;width:1.35in;line-height:0.14in;"><span
            style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Times;color:#000000;white-space:nowrap;text-transform: uppercase;">
            KES {{ strtoupper(NumConvert::word((int) $receipt->amount_paid)) }} ONLY ***
            </span>
        <span style="font-style:normal;font-weight:bold;font-size:8pt;font-family:Times;color:#000000"> </span><br>
    </div>
    <img style="position:absolute;top:3.35in;left:0.98in;width:5.03in;height:0.01in" src="{{asset('receipt/vi_6.png')}}">
    ...
    <div style="position:absolute;top:3.62in;left:0.43in;width:0.27in;line-height:0.17in;"><span
            ...
            style="font-style:normal;font-weight:bold;font-size:10pt;font-family:Times;color:#000000"> </span><br></div>
    <div style="position:absolute;top:3.6in;left:0.8in;width:5.68in;line-height:0.14in;"><span
            style="font-style:normal;font-weight:bold;font-size:9pt;font-family:Times;color:#000000;
            display:flex; flex-wrap: wrap;">
            {{ $receipt->description }}
        </span><span style="font-style:normal;font-weight:bold;font-size:8pt;font-family:Times;color:#000000">
        </span><br></div>
    <img style="position:absolute;top:4.19in;left:0.73in;width:5.29in;height:0.01in" src="{{asset('receipt/vi_71.png')}}">
    <div style="position:absolute;top:4.31in;left:0.43in;width:0.56in;line-height:0.17in;"><span
    ...
    <div style="position:absolute;top:4.32in;left:1.72in;width:0.45in;line-height:0.14in;"><span
            style="font-style:normal;font-weight:bold;font-size:12pt;font-family:Times;color:#000000;white-space:nowrap">M-PESA</span><br>
    </div>
    <img style="position:absolute;top:4.46in;left:1.07in;width:4.95in;height:0.01in" src="{{asset('receipt/vi_8.png')}}">
    <img style="position:absolute;top:4.59in;left:3.86in;width:2.16in;height:0.27in" src="{{asset("receipt/vi_9.png")}}">
    <div style="position:absolute;top:4.68in;left:3.91in;width:0.67in;line-height:0.14in;"><span
    ...
    <div style="position:absolute;top:4.68in;left:5.42in;width:0.45in;line-height:0.14in;text-align: end;"><span
            style="font-style:normal;font-weight:bold;font-size:10pt;font-family:Times;color:#000000">{{ $receipt->bill_total }}
        </span><br></div>
    <img style="position:absolute;top:4.85in;left:3.86in;width:2.16in;height:0.27in" src="{{asset('receipt/vi_10.png')}}">
    <div style="position:absolute;top:4.94in;left:3.91in;width:0.95in;line-height:0.14in;"><span
    ...
    <div style="position:absolute;top:4.94in;left:5.42in;width:0.45in;line-height:0.14in; text-align: end;"><span
            style="font-style:normal;font-weight:bold;font-size:10pt;font-family:Times;color:#000000">{{ $receipt->amount_paid }}</span><br>
    </div>
    <img style="position:absolute;top:5.11in;left:3.86in;width:2.16in;height:0.27in" src="{{asset("receipt/vi_11.png")}}">
    <div style="position:absolute;top:5.20in;left:3.91in;width:0.44in;line-height:0.14in;"><span
            style="font-style:normal;font-weight:bold;font-size:10pt;font-family:Times;color:#000000">Balance</span><br>
    </div>
    <div style="position:absolute;top:5.20in;left:5.42in;width:0.45in;line-height:0.14in; text-align: end;"><span
            style="font-style:normal;font-weight:bold;font-size:10pt;font-family:Times;color:#000000">{{ $receipt->balance }}</span><br>
    </div>

    <div
        style="display:flex; justify-content:space-between;position:absolute;top:5.56in;left:0.43in;width:5.6in;line-height:0.13in;">
        ...
        <div style="">
            <span style="font-style:italic;font-weight:normal;font-size:8pt;font-family:Times;color:#000000">Date:
                <strong>{{ date('d-m-Y', strtotime($receipt->created_at)) }}</strong>
            </span>
        </div>
        <div style="">
            <img style="width: 0.64in;"
                src="{{asset("receipt/NBk.png")}}">
        </div>
    </div>
</body>
